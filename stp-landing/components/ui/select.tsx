...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      {...props}
    >
      <SelectPrimitive.ItemText className="flex flex-1 min-w-0 flex-wrap gap-x-2 whitespace-normal">
        {children}
